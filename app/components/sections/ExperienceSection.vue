...
const items = [
  { key: 'rizzult', avatar: '/img/rizzult-logo.png', bullets: 3 },
  { key: 'acme', avatar: '/img/drim-logo.png', bullets: 2 },
  { key: 'freelance', avatar: '/img/ninji-logo.png', bullets: 3 },
  { key: 'brandlab', avatar: '/img/renthop-logo.png', bullets: 2 },
  { key: 'uni', avatar: '/img/scrille-logo.png', bullets: 1 },
]
</script>
