  ...
  <section id="cases">
    ...
    <div class="flex flex-col gap-8 lg:gap-14">
      <article v-for="item in cases" :key="item.href" class="flex flex-col lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <NuxtLink :to="item.href" :class="cn('block bg-white lg:bg-transparent', item.imageOrderClass)">
          <NuxtImg
            :src="item.image"
            :alt="$t(item.title)"
...
const cases = computed(() => [
  {
    ...
    href: localePath('/cases/rizzult-influencers'),
    image: '/img/influencers-case-preview.jpg',
    imageOrderClass: '',
  },
  {
    ...
    href: localePath('/cases/rizzult-brands'),
    image: '/img/brands-case-preview.jpg',
    imageOrderClass: '',
  },
  {
    ...
    href: localePath('/cases/rizzult-talent-manager'),
    image: '/img/managers-case-preview.jpg',
