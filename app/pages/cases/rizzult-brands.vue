<template>
  <!-- eslint-disable vue/no-v-html -- trusted locale copy -->
  <div class="bg-paper">
    <!-- Hero -->
    <section class="bg-paper pt-8 pb-15 lg:pt-25">
      <div class="container flex flex-col gap-10 lg:gap-15">
        ...
        <div class="mx-auto max-w-7xl overflow-hidden rounded-lg">
          <NuxtImg src="/img/brands-preview.jpg" class="h-auto w-full" alt="Rizzult for Brands" />
        </div>
        ...
        <div class="flex flex-col gap-6">
          ...
          <div class="flex flex-col gap-4 lg:flex-row">
            ...
            >
              <p class="text-ink-dim text-xl leading-tight font-semibold">{{ $t(`brands.impact${i}Title`) }}</p>
              ...
              <div class="flex flex-col gap-6">
                <div v-for="i in 4" :key="i" class="bg-surface shadow-card flex items-center gap-5 rounded-xl p-6">
                  ...
                  <div class="flex flex-col gap-2">
                    ...
                    <div class="text-ink-dim flex flex-col gap-2 text-lg" v-html="$t(`brands.process${i}Body`)"></div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="flex flex-col gap-6">
                ...
                >
                  ...
                  <div class="flex flex-col gap-3">
                    ...
                    <div class="text-ink-dim flex flex-col gap-2 text-lg" v-html="$t(`brands.decision${i}Body`)"></div>
                  </div>
                </div>
              </div>
            </div>
...
useSeoMeta({
  ...
  description: () => t('brands.overview'),
  ogTitle: () => t('brands.title'),
  ogDescription: () => t('brands.overview'),
})
...
const roleCardIcons = [
  ...
  '/img/icons/icon-star.png',
  '/img/icons/icon-target.png',
] as const

const decisionCardIcons = [
  '/img/icons/icon-business.png',
  '/img/icons/icon-paper-list.png',
  '/img/icons/icon-path.png',
  '/img/icons/icon-scales.png',
] as const
