...
useSeoMeta({
  ...
  description: () => t('manager.overview'),
  ogTitle: () => t('manager.title'),
  ogDescription: () => t('manager.overview'),
})
...
const decisionCardIcons = [
  '/img/icons/icon-lines.png',
  '/img/icons/icon-mail.png',
  '/img/icons/icon-ab.png',
  '/img/icons/icon-chart.png',
] as const
